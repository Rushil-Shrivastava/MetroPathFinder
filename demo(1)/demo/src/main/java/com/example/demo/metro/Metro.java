...
//        String dest = mostSimilar(destination, stationCoordinates);
    ...
    public static List<ArrayList<String>> result(String source, String destination) throws Exception {
        // Initialize the station coordinates
        initializeStationCoordinates();
...
//        String src = mostSimilar(source, stationCoordinates);
//        String dest = mostSimilar(destination, stationCoordinates);
        String src = NearestMetroStation.nearestMetroStation(source);
        String dest = NearestMetroStation.nearestMetroStation(destination);
    ...
    private static void initializeMetroLine() {
        ...
        stationColors.put("Tughlaqabad", "Violet");
    ...
    private static void initializeStationCoordinates() throws IOException {
        ...
        // Add more stations and their coordinate
    }
